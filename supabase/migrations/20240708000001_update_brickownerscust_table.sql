-- Add missing columns to brickownerscust table if they don't exist
ALTER TABLE IF EXISTS public.brickownerscust
...
-- Realtime for brickownerscust table is handled in a separate migration
